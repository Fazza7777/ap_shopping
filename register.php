...
if($_POST){
    if(empty($_POST['name']) || empty($_POST['email']) || empty($_POST['phone']) || empty($_POST['address']) || empty($_POST['password']) || strlen($_POST['password']) < 4){
       ...
       if(empty($_POST['name'])) $nameError = "Name is require!";
   
       if(empty($_POST['email'])) $emailError = "Email is require!";
   
       if(empty($_POST['phone']))  $phoneError = "Phone number is require!";
   
       if(empty($_POST['address'])) $addressError = "Address is require!";
   
       if(empty($_POST['password'])) $passwordError = "Password is require!";
   
       else if(strlen($_POST['password']) < 4 ) $passwordError = "Password should be 4 chars at least !";  
        ...
        if($user){
          ...
          if($insert){
            ...
            echo "<script>alert('Register Fail , Please try again');window.location.href='register.php';</script>";
            }
        }
    }
   }
				...
				<div class="col-lg-12">
					<div class="login_form_inner">
                        ...
                        <input type="hidden" name="_token" value="<?php echo $_SESSION['_token'] ?>">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="number" class="form-control" id="name" name="phone" placeholder="Phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
                            ...
                            <span class="text-danger"><?php echo empty($addressError) ? '' : $addressError; ?></span>
